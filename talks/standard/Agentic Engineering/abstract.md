...
This 40-minute talk introduces agentic engineering as the discipline of designing those systems: clear intent, curated context, scoped tools, sandboxed workspaces, observable traces, quality gates, human decision points, and feedback loops that improve the workflow over time. It contrasts vibe coding with production-grade agent workflows, explains when to use simple workflows versus autonomous or multi-agent systems, and shows how standards such as MCP and A2A fit into the emerging stack.
